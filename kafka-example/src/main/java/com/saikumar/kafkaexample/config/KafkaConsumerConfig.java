...
public class KafkaConsumerConfig {
   // @Value("${spring.kafka.bootstrap-servers}")
    @Value("${spring.kafka.bootstrap-servers}")
    private String bootsrapService; //we send this to consumer factory

    @Bean
    public Map<String,Object> consumerConfig(){
        Map<String,Object> props = new HashMap<>();
        props.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG,bootsrapService);
        return props;
    }
    ...
    public ConsumerFactory<String, Message> consumerFactory(){
        ...
        jsonDeserializer.addTrustedPackages("com.saikumar.kafkaexample");
